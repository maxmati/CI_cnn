...
def main(n):
    ...
    for cat in catagories:
        ...
        for f in image_files:
            img = cv2.resize(cv2.imread(os.path.join(data_path, cat, f), 1), (100, 100))
    ...
    mnist_classifier = tf.estimator.Estimator(
        model_fn=model_fn((100, 100, 3), 102, 0.01, n),
        model_dir='/home/maxmati/final2/caltech/model_' + str(n)
    )
